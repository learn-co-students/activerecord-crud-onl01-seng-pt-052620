...
def can_be_found_updated_and_saved
  ...
  found = Movie.find_by(title: 'Awesome Flick')
  found.update(title: 'Even Awesomer Flick')
  found.save
end
...
def can_update_using_update_method
  ...
  found = Movie.find_by(title: 'Wat?')
  found.update(title: 'Wat, huh?')
end
...
def can_destroy_a_single_item
  ...
  found = Movie.find_by(title: 'That One Where the Guy Kicks Another Guy Once')
  found.delete
end
